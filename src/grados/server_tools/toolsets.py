...
TOOL_LABELS: dict[str, str] = {
    **{name: "[DEFAULT]" for name in RESEARCH_DEFAULT_TOOLS},
    ...
    "preview_external_consult_packet": "[RECOVERY]",
    "prepare_external_consult_packet": "[RECOVERY]",
    "prepare_external_consult_from_topic": "[RECOVERY]",
    "save_external_consult_result": "[RECOVERY]",
    "audit_external_consult_result": "[RECOVERY]",
    "run_external_consult": "[RECOVERY]",
